...
function ListOldReports($dir) {
	...
	//echo "<tr><th style='text-align:center;'>".$labels['Date']."</th><th style='text-align:center;'>".$labels['Report']."</th></tr>\n";
	echo "<tr><th style='text-align:center;'>Date</th><th style='text-align:center;'>Report</th></tr>\n";
	echo "</thead>\n";
	echo "<tbody>\n";
